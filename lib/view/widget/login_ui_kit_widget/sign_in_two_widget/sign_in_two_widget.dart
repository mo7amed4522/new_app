    ...
    TextSpan(
      ...
      children: const [
        ...
        TextSpan(
          text: 'PAGE',
          style:
              TextStyle(color: Color(0xFFFE9879), fontWeight: FontWeight.w800),
        ),
      ],
    ),
  );
...
Widget footerText() {
  return Text.rich(
    TextSpan(
      style: GoogleFonts.inter(fontSize: 12.0, color: const Color(0xFF3B4C68)),
      children: const [
        TextSpan(text: 'Don’t have an account ?'),
        TextSpan(text: ' ', style: TextStyle(color: Color(0xFFFF5844))),
        TextSpan(
          text: 'Sign up',
          style:
              TextStyle(color: Color(0xFFFF5844), fontWeight: FontWeight.w700),
        ),
      ],
    ),
  );
